# knowledge-blueprint 入库适配记录

来源：html-ppt-skill/templates/full-decks/knowledge-arch-blueprint（MIT，见 UPSTREAM-README.md）
...
4. 契约文件：template.json / layouts.md（8 版式）/ rules.md / 本文件。
